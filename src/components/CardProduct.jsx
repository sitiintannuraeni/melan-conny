...
function CardProduct({ id, img, name, price, items }) {
  ...
  return (
    <Card
      className="flex flex-col mt-4 border border-gray-300 w-full relative h-[400px] lg:h-[450px]"
      shadow={false}
    >
      <CardHeader
        floated={false}
      ...
      >
        <div className="h-[20%]">
          <img
            src={img}
            alt="product-img"
            className="rounded-t-xl cursor-pointer relative z-20 w-full h-[300px] lg:h-[300px] object-cover"
      ...
      <CardFooter>
        <Typography className="font-['Helvetica'] font-normal text-center text-black">

  ...
  return (
    <>
      <div className="bg-black p-7 rounded-xl">
        ...
        <div className="flex flex-col-2 mt-8 gap-20">
          <div className="w-[300px]">
            <Typography className="text-gray-400 text-sm">Name</Typography>
            <Typography className="text-white text-lg">{user.name}</Typography>
          </div>
          <div className="w-[300px] ">
            <Typography className="text-gray-400 text-sm">Email</Typography>
            <Typography className="text-white text-lg">{user.email}</Typography>
          </div>
        </div>
        <div className="flex flex-col-2 mt-8 gap-20">
          <div className="w-[300px]">
          ...
          <div className="w-[300px]">
            ...
            <Typography className="text-white text-lg">{user.phone}</Typography>
          </div>
        </div>
        <div className="mt-9">
          <Typography className="text-gray-400 text-sm">Gender</Typography>
          <Typography className="text-white text-lg">Ultraman</Typography>
        </div>
      </div>
    </>
  );

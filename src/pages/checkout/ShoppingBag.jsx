...
import { useAddPaymentOrderMutation } from "../../services/apiOrder";
...
function ShoppingBag() {
  ...
  const handlePayNow = () => {
    ...
    const dataPaymentOrder = {
      delivery_type_id: 1,
      shipping_address_id: 30,
      items: items,
    };
    addPeymentOrder(dataPaymentOrder);
  };

  if (isSuccessOrder) {
    const snapToken = responseOrder.data.snap_token;
    navigate(`/payment/${snapToken}`);
  }
